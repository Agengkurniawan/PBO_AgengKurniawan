...
<html lang="en">
  ...
  <!-- Jumbotron -->
      <div class="jumbotron jumbotron-fluid text-center">
        <div class="container">
          <h1 class="display-4"><span class="font-weight-bold">WarungAgee</span></h1>
          <hr>
          <p class="lead font-weight-bold">Sugeng Rawuh <br> 
          Sumonggo Pinarak Rumiyen</p>
        </div>
      </div>
  <!-- Akhir Jumbotron -->
  ...
  <!-- Navbar -->
      <nav class="navbar navbar-expand-lg  bg-secondary">
        <div class="container">
        <a class="navbar-brand text-white" href="admin.php"><strong>Warung</strong> Agee</a>
  ...
  <!-- Menu -->    
      <div class="container">
        <div class="judul text-center mt-5">
          <h3 class="font-weight-bold">WarungAgee</h3>
          <h5>Ponorogo, Jawa Timur
  ...
  <!-- Awal Footer -->
      ...
      <div class="container">
        <div class="row footer-body">
          <div class="col-md-6">
          <div class="copyright">
            <strong>Copyright</strong> <i class="far fa-copyright"></i> 2023 -  Designed by AgengKurniawan</p>
          </div>
          </div>
